    ...
    if len(sys.argv) > 1:
        ...
        try:
            ...
            if d_decrease > 0 and t_decrease > 0:
                ...
                print("   ⚠️  WARNING: No significant decrease detected")
            ...
            if he4_produced > 0 and n_produced > 0:
                ...
                print("   ⚠️  WARNING: No significant production detected")
            ...
            if reactants_consumed > 0 and products_created > 0:
                ...
                print("   ⚠️  WARNING: No significant reaction activity detected")
        ...
        print("ℹ️  No data path provided. Showing prediction only.")
        return 0
